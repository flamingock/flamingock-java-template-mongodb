...
/**
 * Validator for operations that do not accept any parameters (e.g., createCollection, dropCollection, dropView).
 * Rejects non-null, non-empty parameters to prevent silent misconfiguration.
 */
public class NoParametersValidator implements OperationValidator {

    private final String operationName;

    public NoParametersValidator(String operationName) {
